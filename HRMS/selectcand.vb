...
Public Class selectcand
    ...
    Sub loaddata()
        ...
        Try
            ...
            sqlcommand.CommandText = "select Idrec, FullName, Position, PlaceOfBirth, DateOfBirth, Gender, Religion, Address, IdNumber, PhoneNumber, Status from db_recruitment where status != 'Pending'"
    ...
    Private Sub GridView1_PopupMenuShowing(sender As Object, e As DevExpress.XtraGrid.Views.Grid.PopupMenuShowingEventArgs) Handles GridView1.PopupMenuShowing
        If e.MenuType = DevExpress.XtraGrid.Views.Grid.GridMenuType.Row Then
            e.Menu.Items.Add(New DXMenuItem("Select Candidates", New EventHandler(AddressOf SimpleButton3_Click)))
        End If
    End Sub
End Class